...
"""
This code is for training, and testing the eye state.
"""
...
class Solver(object):
    ...
    def init(self):
        ...
        if self.net.is_train:
            ...
            self.lr_summary = tf.compat.v1.summary.scalar('learning_rate_summary', self.LR) #LR from set_optimizer(self)
